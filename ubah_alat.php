...
// alat.lok AS lok,
// alat.merek AS merek,
// alat.tgl_beli AS tgl_beli,
// alat.tgl_install AS tgl_install,
// alat.tipe AS tipe,
// alat.sn AS sn,
// alat.tgl_kal AS tgl_kal,
// alat.ket AS ket,
// alat_kondisi.kondisi AS kondisi,
// alat_kondisi.tgl AS tgl
// FROM
// alat LEFT JOIN alat_kondisi
// ON
// alat.kode=alat_kondisi.kode
// WHERE alat_kondisi.id
// IN
// (SELECT MAX(alat_kondisi.id)
// FROM alat_kondisi
// GROUP BY alat_kondisi.kode)
